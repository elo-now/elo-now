...
`notification:allow-pending-action`

</td>
<td>

Enables the pending_action command without any pre-configured scope.
...
`notification:deny-pending-action`

</td>
<td>

Denies the pending_action command without any pre-configured scope.
