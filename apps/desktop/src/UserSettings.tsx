  ...
  return (
    <>
      ...
      {page === "licenses" && (
        ...
        >
          <LicenseSettings onBack={() => onPage("profile")} />
        </Suspense>
      )}
        ...
        <div className="settings-page general-settings">
          ...
          {mobile && (
            <section aria-labelledby="settings-security-title">
              ...
              <SecuritySettings demoProfile={demoProfile} busy={busy} />
            </section>
          )}
          <section aria-labelledby="settings-view-title">
            ...
            <label className="check">
              ...
              />
              <span>{t("view.enableExpert")}</span>
            </label>
            <p className="muted">{t("view.help")}</p>
            {mode === "expert" && advancedActions}
          </section>
...
function SecuritySettings({
  ...
  const enable = async () => {
    ...
    try {
      ...
      await enableBiometricUnlock(password, demoProfile);
      markBiometricOfferHandled();
      closeDialog();
      await refresh();
