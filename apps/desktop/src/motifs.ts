...
export type Motif = keyof typeof artwork | keyof typeof emojiArtwork;
export const motifs = [
  ...Object.keys(artwork),
...
export function isMotif(value: unknown): value is Motif {
  return (
    typeof value === "string" &&
    (Object.hasOwn(artwork, value) || Object.hasOwn(emojiArtwork, value))
  );
}
...
export function motifImage(
  ...
  const paths = emoji ? null : artwork[motif as keyof typeof artwork];
