...
export function InvitationFlow({
  ...
  const receivedInvitation = received.find((entry) => entry.link === input);
      ...
      {!inline && (
        <ScreenHeader
          ...
          desktopRoot={
            ...
            !preview &&
            !scanning &&
            (((page === "activity" || page === "notifications") && !output) ||
              (page === "contact" && !!initialName.current))
          }
          onBack={goBack}
          actions={
            !mobile && (page === "activity" || page === "notifications") ? (
        ...
        >
          ...
          {codeOutput ? (
            ...
            <>
              ...
              {(!notificationsPage || !view.space_role_requests?.length) &&
                (notificationsPage || !ownedSpace) &&
                !incoming.length &&
                !outgoing.length &&
                !received.length &&
                  ...
                  {received.map((entry) => (
                    <li key={entry.id} className="received-invitation">
                      <button
                        className="member-row"
                        disabled={busy}
                        onClick={() => void perform(() => inspect(entry.link))}
                      >
                        <Icon name="person" />
                        <span className="member-copy">
                          <strong>{entry.name}</strong>
            ...
            <>
              ...
              {requests.length ? (
                ...
                <EmptyState message={t("invite.requests.loading")} />
              )}
            </>
          ) : page === "invitations" ? (
            <>
